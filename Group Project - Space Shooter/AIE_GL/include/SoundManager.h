...
//		myAudio->Pause();
//
// Destroy sounds via the SoundManager when no longer needed to avoid memory leaks.
...
public:
	...
	static SoundManager *Instance() { return m_pInstance; }
...
protected:
	...
	static void Create() { m_pInstance = new SoundManager(); }
